...
class StochasticActionTokenizer(Tokenizer):
    def __init__(
        self,
        data_mean: ArrayLike,
        data_std: ArrayLike,
    ...
    def encode(
        ...
        self.action_dim = trajectory.shape[-1]
        if self.normalize:
    ...
    def decode(
        ...
        if self.normalize:
            ...
            return trajectory.squeeze(2)[..., :self.action_dim] * std + mean
        else:
            return trajectory.squeeze(2)[..., :self.action_dim]
